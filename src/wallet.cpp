...
// ZonkiNutCoin: total coins staked (non-spendable until maturity)
...
// ZonkiNutCoin: check 'spent' consistency between wallet and txindex
// ZonkiNutCoin: fix wallet spent state according to txindex
...
// ZonkiNutCoin: disable transaction (only for coinstake)
