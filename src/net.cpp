...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("ZonkiNutCoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("ZonkiNutCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ZonkiNutCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"192.241.253.108", "192.241.253.108"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("ZonkiNutCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("ZonkiNutCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("ZonkiNutCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("ZonkiNutCoin-msghand");
...
void ThreadMessageHandler2(void* parg)
{
    ...
    while (!fShutdown)
    {
        ...
        // Reduce vnThreadsRunning so StopNode gets permission to exit while
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ZonkiNutCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("ZonkiNutCoin-start");
