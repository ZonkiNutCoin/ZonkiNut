...
!define URL http://www.ZonkiNutCoin.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/ZonkiNutCoin.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\ZonkiNutCoin-qt.exe
...
OutFile ZonkiNutCoin-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/ZonkiNutCoin-qt.exe
    ...
    #Delete /REBOOTOK $INSTDIR\ZonkiNutCoin.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\ZonkiNutCoin-qt.exe
...
Section -un.post UNSEC0001
    ...
    DeleteRegKey HKCR "ZonkiNutCoin"
